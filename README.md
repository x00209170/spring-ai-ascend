...
- Architecture baseline: **65 §4 constraints · 95 ADRs · 126 active gate rules · 220 gate self-tests** · 13 Layer-0 governing principles · 160 enforcer rows · 37 active engineering rules (D-/R-/G-/M- namespace per [ADR-0086](docs/adr/0086-rule-namespace-ratchet.yaml); rc14 adds Rule G-8; rc15 widens G-8.e+G-8.d+G-3.e; rc16 adds 4 gate-layer rules per ADR-0093; rc17 splits R-C→R-C+R-C.1+R-C.2, R-I→R-I+R-I.1, G-3→G-3+G-3.1, G-2→G-2+G-2.1 and adds Rule G-9 per ADR-0094 = +6 engineering rules; rc18 is pure hardening — no new rules per ADR-0095; rc19 adds 3 prevention gate rules — Rule 112 META-of-META + Rule 113 paren guard + Rule 114 filename convention — per ADR-0096; engineering-rule count unchanged) · 9 recurring defect families catalogued (rc19 promotes F-recursive-prevention-irony to closed per ADR-0096) · 374 Maven tests green · architecture-graph nodes / edges regenerated post-merge (402 / 656 at rc19 Wave 5: rc18 baseline 395/642 + 3 rules + 3 enforcers + ADR-0096). Canonical structured baseline lives in [`docs/governance/architecture-status.yaml#architecture_sync_gate.baseline_metrics`](docs/governance/architecture-status.yaml) (single source of truth). Wave history lives at [`docs/logs/governance-waves.md`](docs/logs/governance-waves.md). Gate enforcement: Rule G-2.b + Rule G-2.d + Rule G-2.1.a + Rule G-5.a + Rule G-5.b + Rule G-5.c + Rule 101 + Rule 105 + Rule 106 + Rule 107 + Rule 108 + Rule 109 + Rule 110 META + Rule 111 (rc17, hardened in rc18 Wave 1 + rc19 Wave 1 per ADR-0096) + Rule 112 META-of-META (rc19 Wave 1) + Rule 113 paren guard (rc19 Wave 2) + Rule 114 filename convention (rc19 Wave 4) + Rule 44 (rc18 Wave 2 shallow-clone safeguard).
