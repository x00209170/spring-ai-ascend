...
public class MainAgentConfiguration {
    ...
    private static final class MainAgentHandler extends OpenJiuwenAgentRuntimeHandler {
        ...
        protected BaseAgent createOpenJiuwenAgent(AgentExecutionContext context) {
            ...
            // lazyInitSkill() requires sysOperationId to create SkillUtil.
            // Without it, registerSkill() silently does nothing.
            config.setSysOperationId(AGENT_ID);
            agent.configure(config);

            // Now registerSkill() can initialize SkillUtil and load the skill.
            Path skillsDir = Path.of("examples", "agent-runtime-a2a-versatile-parent-e2e", "skills");
